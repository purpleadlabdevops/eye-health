<section class="care">
  <div class="care__eye">
    <video class="care__video" width="400" height="300" autoplay muted loop poster="<?php echo IMG; ?>/yey.png">
      <source src="<?php echo VIDEO; ?>/eye.mp4" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'>
    </video>
    <svg class="care__top" width="1440" height="208" viewBox="0 0 1440 208" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 208C452.302 -69.1041 987.698 -69.1041 1440 208L1440 0.000551226L0 0.000488281V207.96V208Z" fill="#FFFEF4"/></svg>
  ...
  <div class="care__wrap">
    <div class="container">
      ...
      <div class="care__info">
        ...
        <a class="btn btn-white btn-lg txt-18" href="#">BOOK AN APPOINTMENT</a>
      </div>
    </div>
  </div>
</section>